...
public class Ejercicio3 {
    ...
    public static void main(String[] args) {
        Operacion num1 = new Operacion();
        
        
        System.out.println("Ingreso dos numero");
        ...
        System.out.println("la suma es igual a: " + num1.sumar());
        System.out.println("la resta es igual a: " + num1.restar());
        System.out.println("la multiplicacion es igual a: " + num1.multiplicar());    
        System.out.println("la division es igual a: " + num1.dividir());
